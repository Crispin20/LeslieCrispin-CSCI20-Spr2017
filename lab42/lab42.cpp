...
double ITEMS_PRICE[] = {3.50, 7.75, 4.50, 2.50, 1.50, 1.30, 4.50, 4.75, 3.50, 12.75};
 ...
 cout << "What do you want to purchase?  Enter the number" << endl;
    cin >> num;
    cout << "Added to cart: " << ITEMS_NAME[num] << " Price: " << ITEMS_PRICE[num] << endl; 
    cartTotal = cartTotal + ITEMS_PRICE[num];
    cout << "Cart total: $" << fixed << setprecision(2) << cartTotal << endl;   
...
for(int i  = 0; 0 < 10; i++ ){
      cout << i <<  " Item: " << ITEMS_NAME[i] << ", Price: " << fixed << setprecision(2) << ITEMS_PRICE[i] << endl;
    }
    //maybe a sum  ask april 
  cout << "What do you want to purchase?  Enter the number" << endl;
    cin >> num;
    cout << "Added to cart: " << ITEMS_NAME[num] << " Price: " << ITEMS_PRICE[num] << endl; 
    cartTotal = cartTotal + ITEMS_PRICE[num];
 ...
 //here enter the subtract the array SUB 
